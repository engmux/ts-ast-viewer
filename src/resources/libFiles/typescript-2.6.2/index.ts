...
export {default as export22} from "./lib.es5";
export {default as export23} from "./lib.es6";
export {default as export24} from "./lib.esnext.asynciterable";
export {default as export25} from "./lib.esnext";
export {default as export26} from "./lib.esnext.full";
export {default as export27} from "./lib.scripthost";
export {default as export28} from "./lib.webworker";
